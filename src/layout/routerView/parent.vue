...
onMounted(() => {
	getIframeListRoutes();
	// https://github.com/akram8/oginix-vite-demo/issues/I58U75
	// https://github.com/akram8/oginix-vite-demo/issues/I59RXK
	// https://github.com/akram8/oginix-vite-demo/pulls/40
	nextTick(() => {
		setTimeout(() => {
...
// https://toscode.gitee.com/lyt-top/oginix-vite-demo/pulls/38/files
watch(
	() => route.fullPath,
	() => {
